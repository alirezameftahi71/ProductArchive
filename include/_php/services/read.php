...
<?php
	$select_query = "SELECT DISTINCT game.*, GROUP_CONCAT(DISTINCT genre.name) AS genres, GROUP_CONCAT(DISTINCT platform.name) AS platforms, GROUP_CONCAT(DISTINCT publisher.name) AS publishers
	FROM game
